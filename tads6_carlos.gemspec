...
require "tads6_carlos/version"

Gem::Specification.new do |spec|
  spec.name          = "tads6_carlos"
  spec.version       = Tads6Carlos::VERSION
  spec.authors       = ["Carlos Henrique Ribeiro"]
  spec.email         = ["carlos.egmw@gmail.com"]
